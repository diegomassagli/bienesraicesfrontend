      ...
      styles={css`
        ...
        *, *:before, *:after {
        ...
        body{
          ...
          .contenedor{
            max-width: 1200px; //o 120rem
            margin: 0 auto;
            width: 95%;
          }
          img{
            max-width: 100%; //para hacerlas responsive. asi nunca se achica pero nunca crece mas que su tamaño original. con width:100% + height: auto puede crecer y perder calidad
          }
        }
      `}
    />
